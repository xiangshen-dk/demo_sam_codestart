package com.aws.codestar.demo.model;
...
public class ServerlessOutput {
    ...
    public ServerlessOutput(final String body, final Map<String, String> headers, final int statusCode) {
    ...
    public String toString() {
        return "ServerlessOutput [statusCode=" + statusCode + ", headers=" + headers + ", body=" + body + "]";
    }
}